...
import { BarChart3, BriefcaseBusiness, Home, Lightbulb, LogOut, MessageSquareQuote, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'recommend', label: '推荐', to: '/recommend', icon: Lightbulb },
