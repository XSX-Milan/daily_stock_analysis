...
class Config:
    ...
    # === 推荐股票配置 ===
    recommend_weight_technical: int = 30
    recommend_weight_fundamental: int = 25
    ...
    recommend_refresh_market: str = ""
    recommend_refresh_sector: str = ""
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            recommend_weight_technical=parse_env_int(os.getenv('RECOMMEND_WEIGHT_TECHNICAL'), 30, field_name='RECOMMEND_WEIGHT_TECHNICAL', minimum=0, maximum=100),
            recommend_weight_fundamental=parse_env_int(os.getenv('RECOMMEND_WEIGHT_FUNDAMENTAL'), 25, field_name='RECOMMEND_WEIGHT_FUNDAMENTAL', minimum=0, maximum=100),
            recommend_weight_sentiment=parse_env_int(os.getenv('RECOMMEND_WEIGHT_SENTIMENT'), 20, field_name='RECOMMEND_WEIGHT_SENTIMENT', minimum=0, maximum=100),
            recommend_weight_macro=parse_env_int(os.getenv('RECOMMEND_WEIGHT_MACRO'), 15, field_name='RECOMMEND_WEIGHT_MACRO', minimum=0, maximum=100),
            recommend_weight_risk=parse_env_int(os.getenv('RECOMMEND_WEIGHT_RISK'), 10, field_name='RECOMMEND_WEIGHT_RISK', minimum=0, maximum=100),
            recommend_refresh_skip_seconds=parse_env_int(os.getenv('RECOMMEND_REFRESH_SKIP_SECONDS'), 300, field_name='RECOMMEND_REFRESH_SKIP_SECONDS', minimum=0),
            recommend_sector_top_n=parse_env_int(os.getenv('RECOMMEND_SECTOR_TOP_N'), 10, field_name='RECOMMEND_SECTOR_TOP_N', minimum=1),
            recommend_top_n_per_sector=parse_env_int(recommend_top_n_per_sector_raw, 5, field_name='RECOMMEND_TOP_N_PER_SECTOR', minimum=1),
            recommend_max_universe=parse_env_int(os.getenv('RECOMMEND_MAX_UNIVERSE'), 200, field_name='RECOMMEND_MAX_UNIVERSE', minimum=1),
            recommend_score_threshold_ai=parse_env_int(os.getenv('RECOMMEND_SCORE_THRESHOLD_AI'), 60, field_name='RECOMMEND_SCORE_THRESHOLD_AI', minimum=0, maximum=100),
            recommend_auto_refresh=parse_env_bool(os.getenv('RECOMMEND_AUTO_REFRESH'), True),
            recommend_refresh_time=os.getenv('RECOMMEND_REFRESH_TIME', '18:00'),
            recommend_refresh_market=os.getenv('RECOMMEND_REFRESH_MARKET', '').strip(),
            recommend_refresh_sector=os.getenv('RECOMMEND_REFRESH_SECTOR', '').strip()
        )
