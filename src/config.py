...
class Config:
    ...
    def _load_from_env(cls) -> "Config":
        ...
        return cls(
            ...
            recommend_weight_technical=int(
                os.getenv("RECOMMEND_WEIGHT_TECHNICAL", "30")
            ),
            recommend_weight_fundamental=int(
                os.getenv("RECOMMEND_WEIGHT_FUNDAMENTAL", "25")
            ),
            recommend_weight_sentiment=int(
                os.getenv("RECOMMEND_WEIGHT_SENTIMENT", "20")
            ),
            ...
            recommend_auto_refresh=os.getenv("RECOMMEND_AUTO_REFRESH", "true").lower()
            == "true",
