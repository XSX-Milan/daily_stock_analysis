...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "RECOMMEND_WEIGHT_TECHNICAL": {
        ...
        "description": "Technical analysis weight in recommendation scoring.",
        "category": "recommendation",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "RECOMMEND_WEIGHT_FUNDAMENTAL": {
        ...
        "description": "Fundamental analysis weight in recommendation scoring.",
        "category": "recommendation",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "RECOMMEND_WEIGHT_SENTIMENT": {
        ...
        "description": "Sentiment analysis weight in recommendation scoring.",
        "category": "recommendation",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "RECOMMEND_WEIGHT_MACRO": {
        "title": "Macro Weight",
        "description": "Macro environment weight in recommendation scoring.",
        "category": "recommendation",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "RECOMMEND_WEIGHT_RISK": {
        "title": "Risk Weight",
        "description": "Risk dimension weight in recommendation scoring.",
        "category": "recommendation",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "RECOMMEND_REFRESH_SKIP_SECONDS": {
        "title": "Refresh Skip Seconds",
        "description": "Skip refreshing cached recommendation records updated within this many seconds.",
        "category": "recommendation",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "RECOMMEND_SECTOR_TOP_N": {
        "title": "Sector Top N",
        "description": "Max number of candidates selected from each sector scan.",
        "category": "recommendation",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "RECOMMEND_TOP_N_PER_SECTOR": {
        "title": "Top N Per Sector",
        "description": "Number of highest-scoring stocks kept per sector before deep analysis.",
        "category": "recommendation",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "RECOMMEND_MAX_UNIVERSE": {
        "title": "Max Universe",
        "description": "Maximum number of stocks considered in a sector before ranking filters apply.",
        "category": "recommendation",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "RECOMMEND_SCORE_THRESHOLD_AI": {
        "title": "AI Threshold Score",
        "description": "Minimum composite score required before AI refinement.",
        "category": "recommendation",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "RECOMMEND_REFRESH_MARKET": {
        ...
        "description": "Optional market filter used by scheduled recommendation refresh (CN, HK, US).",
        "category": "recommendation",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "RECOMMEND_REFRESH_SECTOR": {
        "title": "Refresh Sector",
        "description": "Optional sector filter used by scheduled recommendation refresh.",
        "category": "recommendation",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "RECOMMEND_AUTO_REFRESH": {
        "title": "Auto Refresh Enabled",
        "description": "Enable daily auto refresh for recommendation results in serve modes.",
        "category": "recommendation",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "RECOMMEND_REFRESH_TIME": {
        ...
        "description": "Daily recommendation refresh time in HH:MM (CST).",
        "category": "recommendation",
        "data_type": "time",
        "ui_control": "time",
        "is_sensitive": False,
